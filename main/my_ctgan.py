...
from torch.nn import BatchNorm1d, Dropout, Linear, Module, SiLU, Sequential, functional
...
class KAN_Discriminator(Module):
    ...
    def __init__(self, input_dim, discriminator_dim, pac=10, 
        ...
        for item in list(discriminator_dim):
            seq += [KANLinear(dim, item, grid_size=grid_size, 
                            ...
                            grid_eps=grid_eps, 
                            grid_range=grid_range), SiLU(0.2), Dropout(0.5)]
            dim = item

        # seq += [KANLinear(dim, 1, grid_size=grid_size,
        #               spline_order=spline_order, 
        #               scale_noise=scale_noise, 
        #               scale_base=scale_base,
        #               scale_spline=scale_spline,
