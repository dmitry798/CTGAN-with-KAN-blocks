...
print("   • target_epsilon=12 (больше утечки приватности → выше качество)")
print("   • grid_size_gen=8 (гибче аппроксимирует распределения)")
...
synthesizer = KAN_CTGAN(
    ...
    grid_size_gen=8,           # Увеличиваем для лучшей аппроксимации
    spline_order_gen=3,        # Оставляем, работает хорошо
    target_epsilon=12,         # ГЛАВНОЕ: больше epsilon = лучше качество (но меньше приватности)
