"""
CTGAN Testing Script for Credit Scoring Dataset
Тестирование CTGAN модели на датасете кредитного скоринга
"""
...
try:
    ...
    print("Please run train_ctgan_credit_scoring.py first to train the model.")
    exit(1)
...
output_path = '../synthetic_test_output_ctgan_credit_scoring.csv'
